...
import models
from trainer import ResNetTrainer,RAJNetTrainer,VGGTrainer
#from evaluators import Evaluator
from utils.serialization import load_checkpoint, save_checkpoint
from loss import FocalLoss,TripletLoss
import torchvision
from evaluators import Evaluator
...
def main(args):
    ...
    trainer = VGGTrainer(model,criterion)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        top1 = evaluator.evaluate(test_loader, query_set, gallery_set)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--logs-dir', type=str, metavar='PATH', default=os.path.join(working_dir, 'logs/vgg16_triplet'))

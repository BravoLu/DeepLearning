...
image_root = '/data/home/popeyepeng/shaohao/vehicle-reid/data/VehicleID_V1.0/raw/image/'
attr_root = '/data/home/popeyepeng/shaohao/vehicle-reid/data/VehicleID_V1.0/raw/attribute/'
list_root = '/data/home/popeyepeng/shaohao/vehicle-reid/data/VehicleID_V1.0/raw/train_test_split/'

train_ratio = 0.9

train_list = '/data/home/popeyepeng/shaohao/vehicle-reid/data/train_img2model.list'
f_train = open(train_list, 'w')
val_list = '/data/home/popeyepeng/shaohao/vehicle-reid/data/val_img2model.list'
...
print('{} {} has been generated!'.format(train_list,val_list))

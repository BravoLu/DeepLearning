...
train_list = '/data/home/popeyepeng/shaohao/vehicle-reid/VehicleID_V1.0/train_vehicleModel.list'
f_train = open(train_list, 'w')
val_list = '/data/home/popeyepeng/shaohao/vehicle-reid/VehicleID_V1.0/val_vehicleModel.list'

...
ROOT = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop'
attr_root = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Dikong_V01/attribute/'
image_root = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Dikong_V01/images/'
test_path = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Dikong_V01/train_test_split/test_list.txt'

'''
attr_root = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Dikong_v1.0/attribute/'
image_root = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Dikong_v1.0/image/'
test_path = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Dikong_v1.0/train_test_split/test.list'

attr_root = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Suzhou_V2.0/attribute/'
image_root = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Suzhou_V2.0/image/'
test_path = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/Suzhou_V2.0/train_test_split/test_list_2000.txt'
...
test_path = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/VehicleID_V1.0/train_test_split/test_list_800.txt'
test_path = '/data/data1/zhenju/01_Project/00_VehicleReID/00_TestWorkshop/data/VehicleID_V1.0/train_test_split/test_list_13164.txt'
'''
...
f_acs_extractor = Model(inputs = model.input, outputs = model.get_layer(name='f_acs_new').output)

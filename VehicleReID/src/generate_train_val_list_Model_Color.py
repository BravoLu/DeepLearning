...
train_list = 'train_vehicleModelColor_list.txt'
f_train = open(train_list, 'w')
val_list = 'val_vehicleModelColor_list.txt'
...
print('train_vehicleModelColor_list.txt and val_vehicleModelColor_list.txt has been generated!')
